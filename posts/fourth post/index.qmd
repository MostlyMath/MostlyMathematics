...
In this post, we will understand the relation between positive definite kernels and reproducing kernel Hilbert spaces. We will see that every RKHS comes with a unique reproducing kernel, and that every positive definite kernel gives rise to a corresponding RKHS. 
