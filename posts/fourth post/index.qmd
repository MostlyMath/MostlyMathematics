...
To avoid this, we require that the evaluation map $e_x(f) = f(x)$ to be a continuous linear functional for every point $x$. Once this condition holds, the [Riesz representation theorem](https://en.wikipedia.org/wiki/Riesz_representation_theorem) guarantees the existence of the kernel elements $k_x$ and the reproducing property follows naturally. In fact, the continuity of evaluation functions characterizes RKHS.
